...
<body>
    ...
    <script>
                        ...
                        content: {
                            ...
                            teori: `
                                ...
                                <ul>
                                    ...
                                    <li>lim<sub>x→c</sub> f(x) ada</li>
                                    <li>lim<sub>x→c</sub> f(x) = f(c)</li>
                                </ul>
                            `,
                            contoh: `
                                <h4>Contoh 1: Limit Sederhana</h4>
                                <p>Tentukan nilai lim<sub>x→2</sub> (3x + 1)</p>
                                <div class="materi-example">
                                    <p>Penyelesaian:</p>
                                    <p>lim<sub>x→2</sub> (3x + 1) = 3(2) + 1 = 7</p>
                                </div>
                                
                                <h4>Contoh 2: Limit Fungsi Pecahan</h4>
                                <p>Tentukan nilai lim<sub>x→1</sub> (x² - 1)/(x - 1)</p>
                                <div class="materi-example">
                                    <p>Penyelesaian:</p>
                                    <p>lim<sub>x→1</sub> (x² - 1)/(x - 1) = lim<sub>x→1</sub> (x + 1) = 2</p>
                                </div>
                            `,
                            latihan: `
                                <h4>Soal Latihan</h4>
                                <ol>
                                    <li>Tentukan lim<sub>x→3</sub> (2x² - 5x + 1)</li>
                                    <li>Hitung lim<sub>x→0</sub> (sin x)/x</li>
                        ...
                        content: {
                            ...
                            teori: `
                                ...
                                <ul>
                                    ...
                                    <li>Aturan pangkat: d/dx [xⁿ] = nxⁿ⁻¹</li>
        ...
        function showMainApp() {
            ...
            const jadwalSimpan = localStorage.getItem('jadwalData');
            if (jadwalSimpan) {
                jadwalData = JSON.parse(jadwalSimpan);
            }
        ...
        document.querySelectorAll('.nav-link').forEach(link => {
            link.addEventListener('click', function(e) {
                ...
                // Jika halaman jadwal, update tabel jadwal dari data yang tersimpan
                if (pageId === 'jadwal') {
                    // Load jadwal dari localStorage jika ada
                    const jadwalSimpan = localStorage.getItem('jadwalData');
                    if (jadwalSimpan) {
        ...
        // Fungsi untuk memperbarui tabel jadwal di halaman
        function updateTabelJadwal() {
            ...
            waktuArray.forEach(waktu => {
                ...
                hariArray.forEach(hari => {
                    ...
                    if (jadwalData[kunci]) {
                        cell.textContent = jadwalData[kunci].mataPelajaran;
                    } else {
        ...
        document.getElementById('simpanEditJadwal').addEventListener('click', function() {
